...
$$
    The dicretized functions $\e_h, \h_h$ are then satisfy
    $$
	...
	\item $D_y U(x_i',y_j',z_k'):=\frac{U(x_i',y_j'+h/2,z_k')-U(x_i'-h/2,y_j',z_k')}{h}$
        ...
        \item $a_x(U(x_i',y_j',z_k')):=\frac{U(x_i'-h/2,y_j',z_k')+22\times U(x_i',y_j',z_k')+U(x_i'+h/2,y_j',z_k')}{24}$.
                \item $a_y(U(x_i',y_j',z_k')):=\frac{U(x_i',y_j'-h/2,z_k')+22\times U(x_i',y_j',z_k')+U(x_i',y_j'+h/2,z_k')}{24}$.
                        \item $a_z(U(x_i',y_j',z_k')):=\frac{U(x_i',y_j',z_k'-h/2)+22\times U(x_i',y_j',z_k')+U(x_i',y_j',z_k'+h/2)}{24}$.
		\item $\delta_x U:=a_x^{-1}\circ D_x$
	...
	%	\begin{table} [h!]
		...
		%	\begin{table} [h!]
			...
			\begin{equation}\label{eq:lhs}
				...
				\end{pmatrix}.
			\end{equation}
		If one wants a symmetric operator, then one can replace the first and the last row with $24$ in the first and last place of the matrix, implying second order for the first.
